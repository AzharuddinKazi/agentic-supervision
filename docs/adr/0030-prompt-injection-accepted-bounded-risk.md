...
**Decision: accepted risk for v1, bounded by existing guardrails, with an explicit revisit trigger** — not silently absent, and not a blocker to starting development.
